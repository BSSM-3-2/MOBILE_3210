...
const MOCK_POSTS: Post[] = [
    ...
    {
        id: '8',
        userId: '17cbf9bd-0d7f-4f8c-9c2e-2783c4cc0a2b',
        images: [{ type: 'LOCAL', source: macbookImage }],
        likes: 642,
        caption: '코딩하다가 밤샘☕ 새벽 감성이라 사진 한 장 남겨요',
        timestamp: '3일 전',
        comments: [
            {
                id: 'c8-1',
                username: 'nightcode',
                text: '맥북 배터리 괜찮나요? 밤새 작업하려고요',
                timestamp: '3일 전',
                replies: [
                    {
                        id: 'r8-1-1',
    ...
    {
        id: '9',
        userId: 'b5d4104c-31f4-41c7-8b7d-60b18ecb5a26',
        images: [{ type: 'LOCAL', source: renecite }],
        likes: 912,
        caption: '괘법르네시떼역 재방문! 이번엔 해 질 때 찍어봤어요 🌇',
        timestamp: '4일 전',
        comments: [
            {
                id: 'c9-1',
    ...
    {
        id: '10',
        userId: '8989089d-7e34-4803-b90f-3c3551e80da9',
        images: [
            { type: 'LOCAL', source: ba22 },
            { type: 'LOCAL', source: ba },
        ],
        likes: 1280,
        caption: '블아 굿즈 정리하다가 추억여행 떠났어요 🎒',
        timestamp: '5일 전',
        comments: [
            {
                id: 'c10-1',
                username: 'kivotos.alert',
                text: '굿즈 보관 어떻게 하시나요? 곰팡이 걱정ㅠ',
                timestamp: '5일 전',
                replies: [
                    {
                        id: 'r10-1-1',
